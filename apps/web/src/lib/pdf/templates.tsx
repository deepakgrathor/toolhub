...
export function LitePDFTemplate({ title, content, date }: LitePDFProps): React.ReactElement {
    ...
    <Document>
      <Page size="A4" style={liteStyles.page}>
        ...
        <View style={liteStyles.footer} fixed>
          <Text style={liteStyles.footerText}>Generated by SetuLix — setulix.com</Text>
